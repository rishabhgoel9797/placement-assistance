...
<div class="container emp-profile" >
            <form enctype="multipart/form-data" method="post" action="{{route('teacherprofile')}}">
                @csrf
                <div class="row">
                    <div class="col-md-4">
                        <div class="profile-img">
                            <img src="/uploads/avatars/teachers/{{$user->avatar}}" alt=""/>
                        ...
                        <div class="tab-content profile-tab" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p>supraja@ktr.srmuniv.edu.in</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
